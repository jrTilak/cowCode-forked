...
/** Patterns that suggest a "drastic" request: run commands, edit files, browse, schedule, external services. */
const DRASTIC_PATTERNS = [
  ...
  /\b(google|gmail|calendar|search the web)\b/i,
  /\b(apply patch|apply this patch)\b/i,
];

/**
 * Heuristic: does the message likely ask for a high-impact action (run code, edit files, browse, schedule, etc.)?
